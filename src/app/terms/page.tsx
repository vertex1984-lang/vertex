    ...
    <div className="px-6 lg:px-10 py-10">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-12">
          <p className="text-sm font-semibold tracking-widest uppercase text-[#8B5A2B] mb-2">Legal</p>
          <h1 className="text-3xl lg:text-5xl font-extrabold text-[#333] mb-4">Terms of Service</h1>
        ...
        <section className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-bold text-[#333]">Overview</h2>
          </div>
        ...
        <section className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-bold text-[#333]">Online Store Terms</h2>
          </div>
          <div className="bg-white rounded-2xl p-8 shadow-sm space-y-4">
        ...
        <section className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-bold text-[#333]">General Conditions</h2>
          </div>
          <div className="bg-white rounded-2xl p-8 shadow-sm space-y-4">
        ...
        <section className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-bold text-[#333]">Accuracy, Completeness, and Timeliness of Information</h2>
          </div>
          <div className="bg-white rounded-2xl p-8 shadow-sm space-y-4">
        ...
        <section className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-bold text-[#333]">Products, Pricing, and Availability</h2>
          </div>
          <div className="bg-white rounded-2xl p-8 shadow-sm space-y-4">
            <p className="text-[#555]">Some products or services may be available exclusively online and may be subject to our Return &amp; Refund Policy.</p>
        ...
        <section className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-bold text-[#333]">Billing and Account Information</h2>
          </div>
          <div className="bg-white rounded-2xl p-8 shadow-sm space-y-4">
            ...
            <p className="text-[#555]">For details on returns and refunds, please see our Return &amp; Refund Policy.</p>
          </div>
        </section>
        ...
        <section className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-bold text-[#333]">Optional Tools</h2>
          </div>
          <div className="bg-white rounded-2xl p-8 shadow-sm space-y-4">
        ...
        <section className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-bold text-[#333]">User Comments, Feedback, and Submissions</h2>
          </div>
          <div className="bg-white rounded-2xl p-8 shadow-sm space-y-4">
        ...
        <section className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-bold text-[#333]">Personal Information</h2>
          </div>
          <div className="bg-white rounded-2xl p-8 shadow-sm">
            <p className="text-[#555]">
              Your submission of personal information through the Site is governed by our Privacy Policy, which is incorporated into these Terms by reference. Please review our Privacy Policy to understand our practices.
            </p>
          </div>
        </section>
        ...
        <section className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-bold text-[#333]">Errors, Inaccuracies, and Omissions</h2>
          </div>
          <div className="bg-white rounded-2xl p-8 shadow-sm space-y-4">
        ...
        <section className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-9 h-9 rounded-full bg-[#8B5A2B] text-white flex items-center justify-center font-bold text-sm shrink-0">12</div>
            <h2 className="text-xl font-bold text-[#333]">Prohibited Uses</h2>
          </div>
          <div className="bg-white rounded-2xl p-8 shadow-sm space-y-4">
        ...
        <section className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-9 h-9 rounded-full bg-[#8B5A2B] text-white flex items-center justify-center font-bold text-sm shrink-0">13</div>
            <h2 className="text-xl font-bold text-[#333]">Disclaimer of Warranties; Limitation of Liability</h2>
          </div>
          <div className="bg-white rounded-2xl p-8 shadow-sm space-y-4">
        ...
        <section className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-9 h-9 rounded-full bg-[#8B5A2B] text-white flex items-center justify-center font-bold text-sm shrink-0">14</div>
            <h2 className="text-xl font-bold text-[#333]">Indemnification</h2>
          </div>
          <div className="bg-white rounded-2xl p-8 shadow-sm">
        ...
        <section className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-9 h-9 rounded-full bg-[#8B5A2B] text-white flex items-center justify-center font-bold text-sm shrink-0">15</div>
            <h2 className="text-xl font-bold text-[#333]">Severability</h2>
          </div>
          <div className="bg-white rounded-2xl p-8 shadow-sm">
        ...
        <section className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-9 h-9 rounded-full bg-[#8B5A2B] text-white flex items-center justify-center font-bold text-sm shrink-0">16</div>
            <h2 className="text-xl font-bold text-[#333]">Termination</h2>
          </div>
          <div className="bg-white rounded-2xl p-8 shadow-sm space-y-4">
        ...
        <section className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-9 h-9 rounded-full bg-[#8B5A2B] text-white flex items-center justify-center font-bold text-sm shrink-0">17</div>
            <h2 className="text-xl font-bold text-[#333]">Entire Agreement</h2>
          </div>
          <div className="bg-white rounded-2xl p-8 shadow-sm space-y-4">
        ...
        <section className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-9 h-9 rounded-full bg-[#8B5A2B] text-white flex items-center justify-center font-bold text-sm shrink-0">18</div>
            <h2 className="text-xl font-bold text-[#333]">Governing Law</h2>
          </div>
          <div className="bg-white rounded-2xl p-8 shadow-sm">
        ...
        <section className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-9 h-9 rounded-full bg-[#8B5A2B] text-white flex items-center justify-center font-bold text-sm shrink-0">19</div>
            <h2 className="text-xl font-bold text-[#333]">Changes to Terms of Service</h2>
          </div>
          <div className="bg-white rounded-2xl p-8 shadow-sm">
        ...
        <section className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-9 h-9 rounded-full bg-[#8B5A2B] text-white flex items-center justify-center font-bold text-sm shrink-0">20</div>
            <h2 className="text-xl font-bold text-[#333]">Contact Information</h2>
          </div>
          <div className="bg-white rounded-2xl p-8 shadow-sm">
