...
import { PolicyLayout, PolicySection, PolicyContactStrip } from '@/components/Policy';
...
// 内容与 (classic)/shipping-returns 完全一致
export default function V2ShippingReturnPage() {
  return (
    <>
      <V2PageHeader
