...
import { PolicyHeader, PolicySection, PolicyLayout, PolicyContactStrip, TocItem } from '@/components/Policy';
...
export default function TermsPage() {
  return (
    <div className="px-6 lg:px-10 py-10">
      <PolicyHeader eyebrow="Legal" title="Terms of Service" updated="May 2026" />
      ...
      <PolicyLayout toc={TOC}>
        ...
        <PolicySection id="products-pricing-availability" index={5} title="Products, Pricing, and Availability">
          <div className="space-y-4">
            <p className="text-[#555]">Some products or services may be available exclusively online and may be subject to our <a href="/shipping-returns/" className="text-[#8B5A2B] font-medium hover:underline">Return &amp; Refund Policy</a>.</p>
        ...
        <PolicySection id="billing-account-information" index={6} title="Billing and Account Information">
          <div className="space-y-4">
            ...
            <p className="text-[#555]">For details on returns and refunds, please see our <a href="/shipping-returns/" className="text-[#8B5A2B] font-medium hover:underline">Return &amp; Refund Policy</a>.</p>
          </div>
        </PolicySection>
        ...
        <PolicySection id="personal-information" index={10} title="Personal Information">
          <p className="text-[#555]">
            Your submission of personal information through the Site is governed by our <a href="/privacy/" className="text-[#8B5A2B] font-medium hover:underline">Privacy Policy</a>, which is incorporated into these Terms by reference. Please review our <a href="/privacy/" className="text-[#8B5A2B] font-medium hover:underline">Privacy Policy</a> to understand our practices.
          </p>
        </PolicySection>
