...
export const BLOG_POSTS: BlogPost[] = [
  // ==================== 1. Rug Materials ====================
  {
    ...
    cardImage: "/images/products/1688-595229918569-C2/1.webp",
    metaDescription:
    ...
    lede:
      "Most soft, affordable area rugs are made from one of three materials: faux rabbit fur, faux cashmere, or printed low-pile polyester. The short answer: choose faux rabbit fur for the softest barefoot feel in low-traffic rooms, faux cashmere when you want plushness that survives daily use, and printed low-pile polyester for busy areas where easy cleaning matters most.",
    blocks: [
      { type: "p", text: "Here's how the three compare in real homes — including the trade-offs that product listings usually leave out." },
      ...
      { type: "p", text: "That softness has a cost. The long fibers are more delicate than a looped or cut pile, so these rugs show wear faster in hallways and under dining chairs. Most also shed lightly for the first few weeks — this is normal and settles with regular, gentle vacuuming. Because the fibers trap crumbs and dust, homes with messy pets may find them demanding to keep clean." },
      {
        ...
        cons: [
          ...
          "Traps crumbs and dust — needs more frequent cleaning",
        ],
      },
      {
        type: "products",
      ...
      { type: "p", text: "Faux cashmere is a fine, densely woven polyester with a brushed finish. It reads as \"soft\" rather than \"furry\" — smoother and lower than faux rabbit fur, but noticeably denser. That density is the practical difference: the fibers spring back instead of matting, so these rugs hold their look in living rooms and under furniture legs." },
      { type: "p", text: "Many faux cashmere rugs add a silicone non-slip backing, which solves a second problem — rugs that slide on hard floors. If you're choosing one rug for a family living room and want softness and sanity, this is usually the better-balanced pick. The trade-off: it doesn't have the dramatic, fluffy look of fur, and the hand-feel, while soft, is less luxurious." },
      {
        type: "products",
        products: [
          {
      ...
      {
        type: "takeaway",
        text: "The takeaway: faux rabbit fur wins on feel, printed polyester wins on practicality, and faux cashmere splits the difference. Match the material to the room's traffic level first, and the decision largely makes itself.",
      },
    ],
    recos: [
      { slug: "rug-size-guide", image: "/images/products/1688-744995685423-C2/1.webp", cat: "Buying Guides", title: "Rug Size Guide: How to Choose the Right Rug for Every Room" },
      { slug: "low-pile-vs-shag", image: "/images/products/1688-744995685423/1.webp", cat: "Rug 101", title: "Low Pile vs. Shag: Pile Height, Explained" },
    ],
    cta: {
  ...
  // ==================== 2. Rug Size Guide ====================
  {
    ...
    cardImage: "/images/products/1688-744995685423-C2/1.webp",
    metaDescription:
    ...
    lede:
      "The fastest rule in rug sizing: at least the front legs of your sofa or bed should sit on the rug, with roughly 6–12 inches (15–30 cm) of rug extending beyond the furniture on each side. And when you're torn between two sizes, go larger — an undersized rug is the single most common living room mistake.",
    blocks: [
      ...
      { type: "p", text: "A rug anchors a seating or sleeping group. If only the coffee table sits on it and all the furniture legs land on bare floor, the room reads as disconnected — and the rug looks like an afterthought, no matter how good it is." },
      ...
      {
        type: "image",
        src: "/images/products/1688-744995685423/1.webp",
      ...
      { type: "h2", text: "Frequently asked questions" },
      {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: "On hard floors, yes — it prevents sliding (a safety issue), adds cushioning, and reduces wear on both the rug backing and the floor finish. On carpet, pads are mostly unnecessary.",
          },
          {
      ...
      {
        type: "takeaway",
        text: "The takeaway: front legs on the rug, 30–45 cm of floor visible around the edges, and size up when in doubt. Get those three right and almost any rug style will work in the room.",
      },
    ],
    recos: [
      { slug: "rug-materials", image: "/images/products/1688-595229918569-C2/1.webp", cat: "Materials", title: "Rug Materials Explained: Faux Rabbit Fur, Faux Cashmere & Printed Polyester" },
      { slug: "nursery-rugs", image: "/images/products/1688-996768645117-C2/1.webp", cat: "Buying Guides", title: "Nursery & Bedroom Rugs: Softness, Safety and Size" },
    ],
    cta: {
  ...
  // ==================== 3. Chair Cushion Materials ====================
  {
    ...
    cardImage: "/images/products/B0GD84D8VC/4.webp",
    metaDescription:
    ...
    lede:
      "Almost every tufted chair cushion shares the same recipe: a soft polyester fiberfill inside and a fabric cover outside. The short answer: a printed polyester cover over fiberfill is the practical choice for everyday dining chairs, corduroy covers bring warmth and texture to indoor spaces, and water-resistant fabrics earn their keep on patios and gardens.",
    blocks: [
      { type: "p", text: "The cover — not the filling — is the real material decision. Here's how the three common options differ." },
      { type: "h2", text: "Fill first: what's actually inside" },
      { type: "p", text: "At accessible prices, the filling is almost always polyester fiber (often called fiberfill): a lightweight, springy material that bounces back after sitting and dries quickly if it gets damp. Foam-core cushions exist, but they cost more, feel firmer, and hold water far longer — one reason fiberfill dominates outdoor-rated cushions." },
      ...
      { type: "p", text: "Corduroy covers swap print for texture: the ribbed weave reads as warm and tailored, and it feels noticeably softer against arms and legs than flat polyester. It suits indoor rooms — dining rooms, home offices, reading corners — where its main practical advantage shows: ribs disguise light creasing and daily dust between cleanings." },
      ...
      { type: "p", text: "Two honest caveats: water-resistant is not waterproof — seams and ties still let water through in a downpour, so covered areas are still better. And coatings are what fade first under strong sun; fade-resistant treatments help, but no fabric at this price shrugs off a full summer of direct UV indefinitely. If your chairs live outdoors year-round, plan on covers or a winter indoors." },
      { type: "h2", text: "Frequently asked questions" },
      {
        type: "faq",
        faqs: [
      ...
      {
        type: "takeaway",
        text: "The takeaway: the filling is usually fiberfill — judge quality by density and tufting. Spend your real decision on the cover: printed polyester for value, corduroy for indoor texture, water-resistant fabric wherever rain is possible.",
      },
    ],
    recos: [
      { slug: "cushion-size-guide", image: "/images/products/B0CW19GMPQ/1.webp", cat: "Buying Guides", title: "Chair Cushion Size Guide: Seat Pads, High-Back Sets & Rocking Chair Cushions" },
      { slug: "rug-materials", image: "/images/products/1688-595229918569-C2/1.webp", cat: "Materials", title: "Rug Materials Explained: Faux Rabbit Fur, Faux Cashmere & Printed Polyester" },
    ],
    cta: {
  ...
  // ==================== 4. Chair Cushion Size Guide ====================
  {
    ...
    cardImage: "/images/products/B0CW19GMPQ/1.webp",
    metaDescription:
    ...
    lede:
      "The quick answer: a seat pad should match your chair's seat with roughly 1–2 cm of coverage to spare on each side — most dining and kitchen chairs take a 43 × 43 cm (17″ × 17″) square pad, while chairs with backs are better served by a high-back set around 95 × 45 cm (≈37″ × 18″).",
    blocks: [
      ...
      {
        type: "takeaway",
        text: "The takeaway: measure the seat, keep the pad equal or slightly smaller, match thickness to armrests — and when a chair has a back worth cushioning, a tied two-piece set is the most forgiving format.",
      },
    ],
    recos: [
      { slug: "cushion-materials", image: "/images/products/B0GD84D8VC/4.webp", cat: "Materials", title: "Chair Cushion Materials Compared: Fiberfill, Corduroy & Water-Resistant Fabrics" },
      { slug: "door-mats-101", image: "/images/products/1688-1016436401519/1.webp", cat: "Mats", title: "Door Mats 101: How Entry Mats Actually Trap Dirt" },
    ],
    cta: {
  ...
  // ==================== 5. Pillow Filling ====================
  {
    ...
    cardImage: "/images/products/B0GD846FS2/3.webp",
    metaDescription:
    ...
    lede:
      "Three fills cover almost every pillow in a home: hollow-fibre polyester (light, washable, affordable), down alternative (cloud-like softness without feathers), and memory foam (slow-rebound contouring for targeted support). Short answer: hollow fibre for decorative inserts and guest use, down alternative for everyday sleeping, memory foam where your neck does the work — travel, reading upright, or side sleeping with a sore neck.",
    blocks: [
      { type: "p", text: "Here's how the three actually differ night to night." },
      { type: "h2", text: "The three fills at a glance" },
      {
        type: "table",
      ...
      { type: "h2", text: "Hollow-fibre polyester: the practical workhorse" },
      { type: "p", text: "Hollow fibre is polyester spun into strands with air channels, which keeps it light and lets it spring back after compression. It's the standard fill for decorative cushion inserts — the pads that go inside your favorite covers — because it's cheap, breathable, and genuinely machine washable." },
      ...
      {
        type: "prosCons",
        pros: ["Machine washable — easiest fill to keep fresh", "Light and breathable", "Most affordable fill by a wide margin"],
      ...
      {
        type: "takeaway",
        text: "The takeaway: hollow fibre for covers and guest rooms, down alternative for the pillows you actually sleep on, memory foam for necks that need contouring. Match the fill to the job and the pillow stops being a guess.",
      },
    ],
    recos: [
      { slug: "rug-materials", image: "/images/products/1688-595229918569-C2/1.webp", cat: "Materials", title: "Rug Materials Explained: Faux Rabbit Fur, Faux Cashmere & Printed Polyester" },
  ...
  // ==================== 6. Door Mats 101 ====================
  {
    ...
    cardImage: "/images/products/1688-1016436401519/1.webp",
    metaDescription:
    ...
    lede:
      "A good entry mat does three jobs in about two strides: scrape grit off shoe soles, absorb moisture, and hold both away from your floors. The short answer: split the work — a coarse scraper mat outside the door, an absorbent loop-pile mat inside — and make each one at least as wide as the door, ideally 75–90 cm deep so both feet land on it.",
    blocks: [
      ...
      {
        type: "takeaway",
        text: "The takeaway: one mat can't scrape, absorb and hold at once — pair a scraper outside with an absorbent loop-pile mat inside, each as wide as the door and deep enough for two strides, and the rest of your floors stay cleaner for longer.",
      },
    ],
    recos: [
      { slug: "cushion-size-guide", image: "/images/products/B0CW19GMPQ/1.webp", cat: "Buying Guides", title: "Chair Cushion Size Guide: Seat Pads, High-Back Sets & Rocking Chair Cushions" },
  ...
  // ==================== 7. Low Pile vs Shag ====================
  {
    ...
    cardImage: "/images/products/1688-744995685423/1.webp",
    metaDescription:
    ...
    lede:
      "Pile height — how far the rug's fibers stand above its backing — decides more about daily life with a rug than color or material does. The short answer: low pile (under 1 cm) for doorways, dining rooms and busy floors; medium pile for living rooms; shag (2 cm and up) for bedrooms and barefoot zones. Height decides where a rug can go; material decides how it feels.",
    blocks: [
      { type: "p", text: "Here's the full picture, band by band." },
      ...
      { type: "p", text: "The costs are real, though. Long fibers trap crumbs, dust and pet hair deep in the pile where surface vacuuming can't reach. They snag on vacuum beater bars — you'll need to switch it off or use an upholstery attachment. And in traffic paths, shag mats down and tangles; it's a barefoot-zone material, not a hallway material." },
      {
        type: "products",
        products: [
          {
      ...
      { type: "h2", text: "Frequently asked questions" },
      {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: "In cut-pile constructions, longer fibers mean more initial shedding — the loose ends from manufacturing have more length to work free. It tapers off within weeks; low-pile printed rugs barely shed at all.",
          },
        ],
      },
      {
        type: "takeaway",
        text: "The takeaway: height is a placement decision. Low pile wherever doors, chairs and traffic live; medium for shared rooms; shag only where bare feet are the point — and pair it with the right vacuum routine from day one.",
      },
    ],
    recos: [
      { slug: "clean-soft-rug", image: "/images/products/1688-595229918569-C2/4.webp", cat: "Care & Cleaning", title: "How to Clean a Soft Rug (Without Ruining It)" },
      { slug: "rug-materials", image: "/images/products/1688-595229918569-C2/1.webp", cat: "Materials", title: "Rug Materials Explained: Faux Rabbit Fur, Faux Cashmere & Printed Polyester" },
    ],
    cta: {
  ...
  // ==================== 8. Clean a Soft Rug ====================
  {
    ...
    cardImage: "/images/products/1688-595229918569-C2/4.webp",
    metaDescription:
    ...
    lede:
      "Most soft rugs aren't ruined by dirt — they're ruined by cleaning: too much water, too much heat, or a beater bar that shreds long fibers. The short answer: vacuum gently and often, blot spills immediately (never rub), deep clean sparingly, and dry completely. That's ninety percent of rug care.",
    blocks: [
      ...
      { type: "p", text: "Time matters more than product. Fresh spills sit near the surface; set spills travel into the backing. The sequence:" },
      {
        ...
        items: [
          ...
          "Work from the outside in. Start at the spill's edge and move toward the center — cleaning inward-out spreads the stain into a ring.",
      ...
      {
        type: "takeaway",
        text: "The takeaway: cold water, blotting, gentle vacuuming, rare deep cleans. Almost every ruined soft rug was killed by heat, soaking, or a beater bar — avoid those three and even a plush faux fur rug ages gracefully.",
      },
    ],
    recos: [
      { slug: "low-pile-vs-shag", image: "/images/products/1688-744995685423/1.webp", cat: "Rug 101", title: "Low Pile vs. Shag: Pile Height, Explained" },
  ...
  // ==================== 9. Persian Styling ====================
  {
    ...
    cardImage: "/images/products/1688-745181807454-C5/1.webp",
    metaDescription:
    ...
    lede:
      "A vintage Persian-style rug is the easiest way to give a modern room a sense of history — if you let it lead. The short answer: pull one secondary color from the pattern into your pillows and art, keep the large furniture neutral, and give the rug most of the visual budget for pattern in the room.",
    blocks: [
        ...
        faqs: [
          {
            ...
            a: "Medallion and botanical motifs have cycled in and out of fashion for over a century without ever leaving — that's what makes them classic rather than trendy. The faded treatment, in particular, reads timeless in both traditional and modern rooms.",
          },
          {
            q: "Do vintage rugs work on dark floors?",
            a: "Yes, with one adjustment: keep something light between floor and the rug's darkest tones — a cream sofa leg, a natural fiber runner under the coffee table, or simply choosing a cream-field rather than navy-field design. Contrast keeps the pattern legible.",
          },
          {
            q: "What wall colors are safest?",
            a: "Neutrals — white, off-white, greige, soft grey — let the rug lead. If you want color on walls, pull it from the rug's secondary tones and keep it muted; saturated walls compete with a saturated rug.",
          },
          {
            q: "Can I layer or mix two vintage-style rugs?",
            a: "Yes, and it's a signature boho move. The rule: shared palette (both rugs contain the same 2–3 tones) but different pattern scale — a dense medallion under a wide-border geometric, for example. Same-scale pairs look accidental.",
          },
        ],
      },
      {
        type: "takeaway",
        text: "The takeaway: let the rug carry the pattern, borrow one secondary color for the room's accents, and keep everything else calm. A vintage Persian-style rug doesn't need a themed room — it needs a quiet one.",
      },
    ],
    recos: [
      { slug: "rug-size-guide", image: "/images/products/1688-744995685423-C2/1.webp", cat: "Buying Guides", title: "Rug Size Guide: How to Choose the Right Rug for Every Room" },
  ...
  // ==================== 10. Nursery & Bedroom ====================
  {
    ...
    cardImage: "/images/products/1688-996768645117-C2/1.webp",
    metaDescription:
    ...
    lede:
      "Bedroom and nursery rugs get judged by a different standard than living-room rugs: they're stepped on barefoot at 3 a.m., sat on during floor play, and cleaned far more often. The short answer: prioritize cleanability, then non-slip safety, then size — plushness is the reward you earn after the first three are settled.",
    blocks: [
      { type: "p", text: "Here's how to rank the decisions." },
      ...
      { type: "h2", text: "Frequently asked questions" },
      {
        ...
        faqs: [
          ...
          },
          {
            ...
            a: "A full-size non-slip pad under the rug — safer and more effective than spray grips or tape, which can mark floors. Check that the pad itself is rated for hardwood finishes (some rubber pads discolor polyurethane over time).",
          },
        ],
      },
      {
        type: "takeaway",
        text: "The takeaway: cleanability first, non-slip always, size to the real walk paths — and only then buy the plush. A bedroom or nursery rug earns its softness by surviving its job.",
      },
    ],
    recos: [
      { slug: "rug-size-guide", image: "/images/products/1688-744995685423-C2/1.webp", cat: "Buying Guides", title: "Rug Size Guide: How to Choose the Right Rug for Every Room" },
