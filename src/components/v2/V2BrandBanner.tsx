 ...
 * brand-banner.webp（1456×574 生活场景图）按 1456/380（约 3.8:1）锁定比例全宽展示，
 * object-cover 从上下裁切（object-position 保持 center，沙发主体完整露出）；
 * 极宽屏高度超 85vh 时进一步从上下裁切。移动端同比例，仅文案字号/间距缩小。
  ...
  return (
    <section className="w-full">
      <Reveal>
        <a
          href={v2url('/products/')}
          className="group relative block w-full aspect-[1456/380] max-h-[85vh] overflow-hidden"
        >
          <img
