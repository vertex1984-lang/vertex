 ...
 * 桌面：按 1456/380（约 3.8:1）锁定比例全宽展示，
    ...
    <section className="w-full">
      <Reveal>
        ...
        >
          ...
          <div className="absolute left-0 bottom-0 p-10 lg:p-14 max-w-lg">
            <h3 className="text-3xl lg:text-4xl font-extrabold text-cream tracking-tight leading-tight mb-2.5">
              Instant comfort shift.
            </h3>
            <p className="text-base lg:text-lg text-cream/85 mb-6">
              New textures, new feeling.
            </p>
            <span className="inline-block px-8 py-3.5 rounded-full bg-cream text-brand text-sm lg:text-base font-semibold tracking-wide transition-all duration-300 group-hover:bg-brand group-hover:text-cream">
              Discover More
            </span>
          </div>
        </a>
