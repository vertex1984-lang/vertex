...
// Best Sellers：有 Shopify 数据且在售的产品（Others 类目不进 Featured/Best Sellers/New Arrivals），按标题去重（同款不同色只出现一次），取前 10 个
...
const collections = [
  ...
  {
    category: 'Bedding',
    title: 'Softer Nights Ahead',
    description: 'Breathable duvet cover sets for every bed.',
    image: '/images/collections/bedding.webp',
    href: '/products?cat=bedding',
  },
  {
    category: 'Blankets',
    title: 'Wrapped in Warmth',
    description: 'Plush, cozy throws for couch, sofa & bed.',
    image: '/images/collections/blanket.webp',
